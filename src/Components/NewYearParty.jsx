        ...
        <section className="border-b bg-gray-50">
          <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 md:grid-cols-3">
            <div className="md:col-span-2 relative overflow-hidden rounded-xl p-4 font-bold">
              {/* Background image */}
              <img
                src="https://images.unsplash.com/photo-1703100941329-14ed155b69ee?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D0"
              ...
              <p className="mt-3 text-base text-gray-600" id="about font-bold">
                {/* TODO: Replace this placeholder description with your event copy. */}
                Ring in the New Year with music, dance, and unforgettable
                memories! Join us for a night of celebration, countdowns, and
                good vibes as we welcome a brand new year together.
              </p>

              <div className="mt-5 flex flex-wrap items-center gap-3 text-sm">
                <span className="inline-flex items-center gap-2 rounded-lg border bg-white px-3 py-1.5">
                  <Calendar size={16} /> <span>Dec 31, 2025</span>
                </span>
                <span className="inline-flex items-center gap-2 rounded-lg border bg-white px-3 py-1.5">
                  <Clock size={16} /> <span>20:00</span>
                </span>
                <span className="inline-flex items-center gap-2 rounded-lg border bg-white px-3 py-1.5">
                  <MapPin size={16} />{" "}
                  <span>KIIT Campus 13, Cricket Ground</span>
                </span>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border bg-white p-5">
                <ul className="mt-3 list-disc pl-5 text-sm text-gray-700 space-y-1">
                  <li>Reporing - 21:00</li>
                  <li>Party Starts - 22:00</li>
                  <li>Food & Drinks through-out the night</li>
                  <li>The party doesn't end!!!!!</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section id="rules" className="border-b">
          <div className="mx-auto max-w-6xl px-4 py-10">
            ...
            <ol className="mt-4 list-decimal pl-5 space-y-2 text-sm text-gray-700">
              ...
              <li>Dress to impress! Casual but neat attire is recommended.</li>
              <li>
                Only drinks provided by the event are allowed on the premises.
              </li>
              <li>Dispose of trash properly and respect the venue.</li>
              <li>Have fun and celebrate responsibly!</li>
            </ol>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 py-10">
            ...
            <div className="mt-4 rounded-2xl border bg-white p-4">
              ...
              <div className="mt-4 aspect-video w-full rounded-xl bg-gray-100 grid place-items-center text-sm text-gray-500">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2039.5877374722254!2d85.81648483147801!3d20.357297702239446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1909234b6d901d%3A0xaf4055ab077320f2!2sKIIT%20Cricket%20Ground!5e0!3m2!1sen!2sin!4v1755884813631!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowfullscreen=""
              ...
              {[
                {
                  ...
                  a: "Smart casual or festive attire is recommended.",
                },
                {
                  q: "Is there an age limit to attend?",
                  a: "Yes, attendees must be 18 years or older.",
                },
                {
                ...
                },
                {
                  ...
                  a: "Please check your invitation; some tickets include guest passes.",
                },
              ].map((f) => (
